...
WHERE customers.city = 'London' AND employees.city = 'London' AND shippers.company_name = 'United Packag'
...
WHERE EXISTS (SELECT 1 FROM orders WHERE order_details .quantity = 10 AND orders.order_id=order_details.order_id)
